...
// App Router: useSearchParams() requires a Suspense ancestor, otherwise
// the whole route bails out to client-side rendering and gets stuck on
// the loading UI. Wrap the content that uses it.
